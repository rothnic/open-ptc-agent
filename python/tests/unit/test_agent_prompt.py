...
async def main():
    ...
    print("\n" + "🔍 PROMPT TEMPLATE TEST: Jinja2-based Prompt Generation".center(80))
    print("="*80)
    ...
    print_section(
        "✅ SYSTEM PROMPT (Generated from templates)",
    ...
    loader = get_loader()
    print_section(
        "📄 RESEARCHER TEMPLATE (from loader)",
        loader.get_subagent_prompt("researcher", date="2024-01-15")[:1000] + "\n\n... (truncated)"
    )

    # Analysis
    print("\n" + "📋 TEMPLATE SYSTEM OVERVIEW".center(80))
    print("="*80)
    print("""
...
DIRECTORY STRUCTURE:
  ...
  │   │   ├── researcher.md.j2
  │   │   └── general.md.j2
  │   └── code_execution/ # Code execution prompts
  │       └── ...
  ├── config/prompts.yaml # Configuration & defaults
  ├── loader.py           # Template loading
  └── formatter.py        # Tool summary formatting
...
TOKEN EFFICIENCY:
  ...
  - Both modes support on-demand doc reading for full details
    ...
    print("✨ Test complete! Template system is working.\n")

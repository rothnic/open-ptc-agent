...
/**
 * Result from code execution operations.
 */
...
/**
 * Protocol for sandbox backends that can execute code.
 *
 * Extends BackendProtocol with code execution capabilities.
 * Typically implemented by Daytona or other sandbox environments.
 */
...
/**
 * Factory function type for creating sandbox backend instances.
 */
